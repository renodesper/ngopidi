    ...
    return (
        <main className="relative h-screen w-full overflow-hidden">
                        ...
                        {session?.user ? (
                            <Link href={(session.user as any).role === 'ADMIN' ? '/admin' : '/dashboard'}>
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="rounded-full hover:bg-primary/10 font-medium text-amber-600"
                                >
                                    Dashboard
                                </Button>
                            </Link>
            ...
            <div className="absolute bottom-6 left-6 z-[400]">
                <p className="text-[10px] font-medium tracking-[0.2em] uppercase opacity-30 select-none">
                    Ngopidi &copy; 2026
                </p>
            </div>
        </main>
