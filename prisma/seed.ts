...
async function main() {
  ...
  const coffeeShops = [
    ...
    ...[
      ...
      { name: "Kopi Toko Djawa (Gandapura)", address: "Jl. Gandapura No.61, Bandung", lat: -6.9142, lng: 107.6221 },
      ...
      { name: "Warung Kopi Imah Babaturan", address: "Jl. Kebon Bibit No.3, Bandung", lat: -6.8967, lng: 107.6089 },
      { name: "Makmur Jaya Coffee Roaster", address: "Jl. Lengkong Besar No.62, Bandung", lat: -6.9245, lng: 107.6123 },
